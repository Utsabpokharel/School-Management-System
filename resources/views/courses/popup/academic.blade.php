...
<div class="modal fade" id="academic-year-show" tableindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button class="btn btn-success btn-save-academic">Save</button>
			</div>
		</div>
	</div>	
</div>